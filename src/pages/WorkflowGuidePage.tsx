    ...
    <div className="app-page-shell overflow-auto">
      <div className="app-panel w-full min-h-full p-6 md:p-8">
        <header className="text-center mb-8">
          <h1 className="text-2xl font-bold text-cap-ultramarine mb-2">Workflow Guide</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 items-start">
          <section
            className="rounded-xl border border-gray-200 bg-slate-50 p-4 text-sm text-gray-700"
            aria-labelledby="guided-tips-heading"
          >
            <h2 id="guided-tips-heading" className="font-semibold text-gray-900 mb-2">
              Guided tips (lightbulb icons)
            </h2>
            <p className="mb-3">
              The five numbered steps are the full path to complete the customer report. Throughout those
              ...
              <strong>Tower Data Analysis</strong>, <strong>Map View</strong>, and{' '}
            ...
            <p className="mb-3">
              ...
              sections in order to finish the report the same way.
            </p>
            <p className="mb-2">
            ...
            <p>
              On the <strong>Air Force Report Form</strong>, optional <strong>Additional Notes</strong> sit
              at the <strong>bottom</strong> of the page; the export PDF repeats them on the{' '}
              <strong>last appendix page</strong> under the mission map.
            </p>
          </section>
          <section className="space-y-3" aria-label="Workflow steps">
            {steps.map((step) => (
              <div key={step.number} className="p-3 md:p-4 rounded-xl bg-slate-50 border border-gray-200">
                <div className="flex gap-3 md:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <button
                      ...
                      className="mt-2 text-sm font-medium text-cap-ultramarine hover:underline"
                    >
                      Go to {step.title} →
                    </button>
                  </div>
